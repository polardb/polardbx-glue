 ...
 * @version 1.0
 */
public class DoubleBlockDecoder extends AbstractBlockDecoder {

    private double currentValue;

    public DoubleBlockDecoder(PolarxResultset.Chunk chunk, int columnIndex,
    ...
    public boolean next() throws Exception {
        ...
        if (hasNext) {
            if (currentNull) {
                ...
                currentValue = stream.readDouble();
            }
            return true;
        }
        return false;
    ...
    public Object getObject() throws Exception {
        return currentNull ? null : getDouble();
    }
    ...
    public Decimal getDecimal() throws Exception {
        ...
        final BigDecimal bigDecimal = BigDecimal.valueOf(currentValue);
    ...
    public Slice getString() throws Exception {
        ...
        final String str = Double.toString(currentValue);
