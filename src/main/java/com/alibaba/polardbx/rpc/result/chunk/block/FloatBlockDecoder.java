 ...
 * @version 1.0
 */
public class FloatBlockDecoder extends AbstractBlockDecoder {

    private float currentValue;

    public FloatBlockDecoder(PolarxResultset.Chunk chunk, int columnIndex,
    ...
    public Object getObject() throws Exception {
        return currentNull ? null : getFloat();
    }
    ...
    public Slice getString() throws Exception {
        ...
        final String str = Float.toString(currentValue);
